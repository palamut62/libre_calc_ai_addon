...
class MainWindow(QMainWindow):
    ...
    def _update_ui_text(self):
        ...
        self._help_guide_action.setText(get_text("menu_help_guide", lang))
    ...
    def _setup_menus(self):
        ...
        self._help_guide_action = QAction("Kullanım Kılavuzu...", self)
        self._help_guide_action.triggered.connect(self._show_help)
        self._help_menu.addAction(self._help_guide_action)
