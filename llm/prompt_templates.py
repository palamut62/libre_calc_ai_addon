...
SYSTEM_PROMPT = (
    ...
    "## ARAÇLAR\n"
    "- read_cell_range: Hücre/aralık içeriğini okur. Önce oku, sonra işlem yap.\n"
    ...
    "- set_column_width: Sütun genişliğini mm cinsinden ayarlar\n"
    "- set_row_height: Satır yüksekliğini mm cinsinden ayarlar\n"
